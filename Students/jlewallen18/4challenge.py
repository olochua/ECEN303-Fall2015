...
It is a Gaussian Distribution random variable
...
This is also a Gaussian Distribution random variable
...
Sequence 3 is a exponential districbution random variable
...
covariance between them is small, close to 1/1000

Do you think they are independent? Justify your answer.

Yes. The empirical expectation of (S_1)^2 + (S_2)^2 is the sum of expectations of (S_1)^2 and (S_2)^2 which can only be true if they're independent. Also, the covariance is close to zero, which is another sign that they are independent
